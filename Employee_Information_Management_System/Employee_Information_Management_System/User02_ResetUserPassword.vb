...
Public Class User02_ResetUserPassword
    ...
    Private Sub btnInsert_Click(sender As Object, e As EventArgs) Handles btnInsert.Click
        ...
        If ValidatePassword(pwd, 8, 1, 1, 1) Then
            ...
            Else
                Try
                    Dim cmd As New SqlCommand("Select count(*) from EmpTable Where EmpNo = @eno and Email = @email and password = @pass", con)
                    ...
                    Else
                        Dim cmd1 As New SqlCommand("Update EmpTable set password = @pass where EmpNo = @empno", con)
