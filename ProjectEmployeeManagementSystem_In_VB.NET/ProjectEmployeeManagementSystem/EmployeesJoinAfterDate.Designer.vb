...
Partial Class EmployeesJoinAfterDate
    ...
    Private Sub InitializeComponent()
        ...
        ' DateTimePicker1
        ' 
        DateTimePicker1.Location = New Point(332, 28)
        ...
        ' Button1
        ' 
        Button1.Location = New Point(487, 61)
        ...
        DataGridView1.Size = New Size(570, 292)
        DataGridView1.TabIndex = 3
        ' 
        ' Label2
        ' 
        Label2.Dock = DockStyle.Bottom
        Label2.Location = New Point(0, 406)
        Label2.Name = "Label2"
        Label2.Size = New Size(593, 25)
        Label2.TabIndex = 4
